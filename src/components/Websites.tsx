  ...
  return (
    <div className="album py-5">
      <div className="row">
          ...
          <div className="col-md-4">
          <RSS homepage="https://packinsider.com/" url="https://packinsider.com/feed/" title="Pack Insider" isDarkMode={isDarkMode} />
          </div>
          {/* <div className="col-md-4">
          <RSS homepage="https://gopack.com/" url="https://gopack.com/rss.aspx" title="Go Pack" isDarkMode={isDarkMode} />
          </div> */}
          <div className="col-md-4">
          <RSS homepage="https://bustingbrackets.com/acc/nc-state-wolfpack/" url="https://bustingbrackets.com/acc/nc-state-wolfpack/feed/" title="Busting Brackets" isDarkMode={isDarkMode} />
          </div>
      </div>
    </div>
  );
