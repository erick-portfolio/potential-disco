...
function NavBar(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("nav", __assign({ className: "navbar navbar-expand-lg ".concat(isDarkMode ? "navbar-dark bg-dark" : "navbar-light bg-light"), style: { paddingRight: "20px" } }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ style: { paddingLeft: "20px" } }, { children: (0, jsx_runtime_1.jsx)("a", __assign({ className: "navbar-brand", href: "/" }, { children: "WolfpackWireClone" }), void 0) }), void 0), (0, jsx_runtime_1.jsx)("div", __assign({ className: "ml-auto" }, { children: (0, jsx_runtime_1.jsx)("button", __assign({ className: "btn btn-outline-".concat(isDarkMode ? "light" : "dark"), onClick: toggleDarkMode }, { children: isDarkMode ? "Light Mode" : "Dark Mode" }), void 0) }), void 0)] }), void 0));
}
